...
- **Phase 1**: Deployment pipeline wired (commit b92ee61: dynamic-branched country pipeline URLs → C2a evidence). C1 + C2 ready to run on full `us_body` corpus.
- **Phase 2**: C2 deliverable frozen (v0.9.1, iter 48); Malaysia deployment is the active next step. See `docs/phase_1/malaysia_strategy.md` and `docs/phase_1/CLAUDE.md`.
