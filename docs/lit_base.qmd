...
status <- tibble::tribble(
  ...
  # --- s4 llm text-as-data ---
  "agarwal_consumption_2017", "§3", "cite-only", "yes", "yes", "abstract",
  ...
  "klemm_empirical_2012",     "§7", "benchmark",   "yes", "yes", "abstract"
)
...
**Citekey** `@agarwal_consumption_2017` · Zotero `HYU4XB2C` · **Status** file ✓ · tag ✓ · §3 · consultation: abstract
**Role** cite-only

**Summary.** Agarwal, Marwell & McGranahan (2017, *AEJ: Economic Policy* 9(4):1–27, "Consumption Responses to Temporary Tax Incentives: Evidence from State Sales Tax Holidays") estimate the spending response to state sales tax holidays (STHs) — temporary exemptions for items like clothing, shoes, and school supplies — using two datasets, the Diary portion of the Consumer Expenditure Survey and a credit-card transaction dataset. A difference-in-differences design finds substantial increases in spending on covered goods during the holidays that are not offset by declines in spending before or after.

**Relation.** An effects-of-tax-incentive micro study supporting the consumption-holiday sub-scope of the incentive component — evidence that temporary consumption-tax holidays move household behavior, motivating their inclusion as identifiable incentive events. Sits alongside the cross-country incentive-effectiveness benchmark [[#sec-klemm_empirical_2012]] (micro/US complement to its macro/EM panel) and the rate-vs-base consumption-tax effects in [[#sec-dabla-norris_macroeconomic_2023]]. Links: [[#sec-klemm_empirical_2012]], [[#sec-dabla-norris_macroeconomic_2023]].
...
**Citekey** `@klemm_empirical_2012` · Zotero `Z9MQ9NVB` · **Status** file ✓ · tag ✓ · §7 · consultation: abstract
**Role** benchmark

**Summary.** Klemm & Van Parys (2012, *International Tax and Public Finance* 19(3):393–423, "Empirical evidence on the effects of tax incentives") assemble a new dataset of tax incentives (tax holidays, investment allowances, tax credits, CIT rates) for 40+ Latin American, Caribbean and African countries over 1985–2004 and ask two questions — whether incentives are used as tools of tax competition and how effective they are at attracting investment. Spatial-panel evidence shows strategic interaction in tax holidays (and the well-known competition over CIT rates) but not over investment allowances or tax credits; dynamic-panel evidence finds lower CIT rates and longer tax holidays attract FDI in Latin America and the Caribbean but not in Africa, and no incentive boosts gross private fixed capital formation.

**Relation.** The **incentive-leg statistical-validation comparator** for the methodological paper — the incentive analog of [[#sec-das_ai_2026]] for spending (per `docs/deltas.md` 2026-06-30) — supplying a cross-country tax-incentive dataset and effectiveness benchmark against which our agentically-identified incentive events are positioned. **Dual-fit:** filed §7 (datasets/comparator) but defensibly §1 (motivation — why measuring incentives matters in EMs) or §3 (effects of incentives) — revisit at synthesis. Links: [[#sec-agarwal_consumption_2017]], [[#sec-das_ai_2026]], [[#sec-crispolti_cross-country_2022]].
